  ...
  return (
    ...
    >
      <AuthCard align="center">
        ...
        <h1 className="mb-2 text-[22px] font-semibold tracking-[-0.01em] text-ink">تحقق من بريدك الإلكتروني</h1>
        <p className="text-[15px] leading-relaxed text-ink-muted">
          أرسلنا رابط تأكيد إلى بريدك الإلكتروني. يرجى فتحه لتفعيل حسابك والمتابعة.
        </p>
        <Link
          href="/login"
          className="mt-7 inline-block text-sm font-semibold text-brand-600 transition-colors hover:text-brand-700"
        >
