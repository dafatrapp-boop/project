...
create index landing_pages_public_slug_idx on public.landing_pages (slug) where status = 'published';
...
create index landing_page_views_page_idx on public.landing_page_views (landing_page_id, created_at desc);
...
create function public.set_view_workspace_id()
returns trigger as $$
begin
